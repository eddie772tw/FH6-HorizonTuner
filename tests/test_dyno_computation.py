...
class TestDynoComputation(unittest.TestCase):
    ...
    def test_with_outliers_iqr_filtering(self):
        ...
        # n = 6
        # sorted: [10, 10, 11, 11, 12, 100]
        # q1 = sorted[6//4 = 1] = 10
        # q3 = sorted[3*6//4 = 4] = 12
        # iqr = 12 - 10 = 2
        # lower_fence = 10 - 1.5*2 = 7
        # upper_fence = 12 + 1.5*2 = 15
        ...
        # index 5: 100 (filtered)
        # total_weight = 1 + 2 + 3 + 4 + 5 = 15
        # weighted_sum = 10 + 20 + 33 + 48 + 55 = 166
        # mean = 166 / 15 = 11.066666666666666
        self.assertAlmostEqual(compute_dyno_value([10, 10, 11, 12, 11, 100]), 166.0 / 15.0)
    ...
    def test_all_outliers_fallback(self):
        """If all values are NaN or fall outside valid bounds resulting in total_weight == 0, fallback returns max(history)."""
