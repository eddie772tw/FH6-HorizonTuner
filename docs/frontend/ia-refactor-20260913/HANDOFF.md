...
- G2 維持 `partial`；新 candidate Full partial native observation 已記於 [2026-09-19 native evidence](evidence/g2-native-observations-20260919.md)，actual browser delayed config/reentry 則記於 [2026-09-19 browser evidence](evidence/g2-browser-observations-20260919.md)。Browser response 前回到 Live 與 reentry readback 不替代 native H5；pending native write 尚未完成，Lite native 尚未啟動。先完成 G2；G2 通過並完成 handoff 後暫停，不開 W2，也不公布 `WAVE2_BASE_SHA`。完整目標保留至後續恢復；後續 assignments 僅由 Luna 執行，複雜 shared coordination 由 root 保留。
