...
class TestDragRecorder(unittest.TestCase):
    ...
    def test_recording_and_shift_analysis(self):
        ...
        for i in range(1, 20):
            ...
            self.recorder.record({
                ...
                "TireSlipRatio": [0.01, 0.01, 0.20 - (i*0.005), 0.20 - (i*0.005)]
            })
    ...
    def test_invalid_path_and_high_slip_asymmetry(self):
        ...
        for i in range(50):
            ...
            self.recorder.record({
                ...
                "TireSlipRatio": [0.01, 0.01, 0.25, 0.02], # Large slip diff = 0.23 > 0.08
                "PositionX": x,
                "PositionZ": i * 2.0,
                "Yaw": 0.0
            })
        ...
        self.assertTrue(any("調高" in diag or "鎖定" in diag or "Lock" in diag for diag in res["stability_diagnostics"]))
    ...
    def test_fishtailing_oscillation(self):
        ...
        self.assertTrue(any("降低" in diag or "蛇行" in diag or "Lock" in diag or "鎖定" in diag for diag in res["stability_diagnostics"]))
