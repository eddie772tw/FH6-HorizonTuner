...
export function AppDialog({ title, onClose, children }: { title: string; onClose: () => void; children: ReactNode }) {
  ...
  return <ModalPortal>
    ...
    <div className="modal app-dialog show d-block" role="dialog" aria-modal="true" aria-labelledby={titleId}
      ...
      <div className="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
        <div className="modal-content glass-panel">
          ...
          <div className="modal-body"><div className="settings-surface">{children}</div></div>
        </div>
      </div>
    </div>
  </ModalPortal>;
