...
describe('S650 Normal layout', () => {
  it('maps the reference layout to left RPM and right speed energy dials', () => {
    ...
    layouts.render(
      'normal',
      { redlineRpm: 7000 },
      { background: '#000', primary: '#1351D8', secondary: '#98A0A8', danger: '#FF3B30' },
      0.875,
    );
    ...
    expect(sideGauges[0][4]).toMatchObject({
      activeColor: '#1351D8',
      pointerColor: '#FF3B30',
    });
    ...
    expect(dials[1][10]).toMatchObject({
      tickCount: 10,
      tickLabels: ['0', '30', '60', '90', '120', '150', '180', '210', '240', '270', '300'],
      baseWidth: 48,
      valueSize: 56,
      centerLabel: true,
    });
