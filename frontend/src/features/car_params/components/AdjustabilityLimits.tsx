  ...
  return (
    <div>
      ...
      <div style={{...formRowStyle, opacity: 0.5}}>
        <label>{t("Gearbox")} <span style={{color: 'orange', fontSize: '0.7rem'}}>({t("TODO")})</span></label>
        <select value={carParams.adjustability.gearbox} disabled style={inputStyle}>
      ...
      <div style={{...formRowStyle, opacity: 0.5}}>
        <label>{t("Suspension")} <span style={{color: 'orange', fontSize: '0.7rem'}}>({t("TODO")})</span></label>
        <select value={carParams.adjustability.suspension} disabled style={inputStyle}>
      ...
      <div style={{...formRowStyle, opacity: 0.5}}>
        <label>{t("Anti-roll Bars")} <span style={{color: 'orange', fontSize: '0.7rem'}}>({t("TODO")})</span></label>
        <select value={carParams.adjustability.arb} disabled style={inputStyle}>
          <option value="Fixed">{t("Fixed")}</option>
          <option value="Adjustable">{t("Adjustable")}</option>
        </select>
      </div>
      <div style={{...formRowStyle, opacity: 0.5}}>
        <label>{t("Aero")} <span style={{color: 'orange', fontSize: '0.7rem'}}>({t("TODO")})</span></label>
        <select value={carParams.adjustability.aero || 'Fixed'} disabled style={inputStyle}>
          <option value="Fixed">{t("Fixed")}</option>
      ...
      <div style={{...formRowStyle, opacity: 0.5}}>
        <label>{t("Brakes")} <span style={{color: 'orange', fontSize: '0.7rem'}}>({t("TODO")})</span></label>
        <select value={carParams.adjustability.brakes || 'Fixed'} disabled style={inputStyle}>
          <option value="Fixed">{t("Fixed")}</option>
          <option value="Adjustable">{t("Adjustable")}</option>
        </select>
      </div>
      <div style={{...formRowStyle, opacity: 0.5}}>
        <label>{t("Differential")} <span style={{color: 'orange', fontSize: '0.7rem'}}>({t("TODO")})</span></label>
        <select value={carParams.adjustability.diff || 'Fixed'} disabled style={inputStyle}>
          <option value="Fixed">{t("Fixed")}</option>
          <option value="Adjustable">{t("Adjustable")}</option>
        </select>
      </div>
