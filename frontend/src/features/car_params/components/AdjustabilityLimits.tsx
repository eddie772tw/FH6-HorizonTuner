  ...
  return (
    <div>
      ...
      <div style={{...formRowStyle, opacity: 0.5}}>
        <label>{t("Gearbox")} <span style={{color: 'orange', fontSize: '0.7rem'}}>(TODO)</span></label>
      ...
      <div style={{...formRowStyle, opacity: 0.5}}>
        <label>{t("Suspension")} <span style={{color: 'orange', fontSize: '0.7rem'}}>(TODO)</span></label>
      ...
      <div style={{...formRowStyle, opacity: 0.5}}>
        <label>{t("Anti-roll Bars")} <span style={{color: 'orange', fontSize: '0.7rem'}}>(TODO)</span></label>
      ...
      <div style={{...formRowStyle, opacity: 0.5}}>
        <label>{t("Aero")} <span style={{color: 'orange', fontSize: '0.7rem'}}>(TODO)</span></label>
      ...
      <div style={{...formRowStyle, opacity: 0.5}}>
        <label>{t("Brakes")} <span style={{color: 'orange', fontSize: '0.7rem'}}>(TODO)</span></label>
      ...
      <div style={{...formRowStyle, opacity: 0.5}}>
        <label>{t("Differential")} <span style={{color: 'orange', fontSize: '0.7rem'}}>(TODO)</span></label>
