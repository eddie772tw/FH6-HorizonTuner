...
export class FrameInterpolator {
  ...
  constructor(options: FrameInterpolatorOptions = {}) {
    ...
    this.continuousKeys = options.continuousKeys ? [...options.continuousKeys] : [...DEFAULT_CONTINUOUS_KEYS];
    this.angleKeys = options.angleKeys ? [...options.angleKeys] : [...DEFAULT_ANGLE_KEYS];
