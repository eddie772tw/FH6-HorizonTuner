...
"%UV_EXE%" run --no-project --python "%VENV_PY%" python -c "import fastapi, httpx, numpy, pydantic, pytest, pytest_asyncio, ruff, soundcard, uvicorn, websockets; import multipart; import winrt.windows.media.control" >nul 2>nul
exit /b %errorlevel%
